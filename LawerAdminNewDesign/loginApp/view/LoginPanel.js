console.log("LawerAdminApp.view.LoginPanel.js begins ....");
Ext.define('LoginApp.view.LoginPanel', {
    ...
    items: [
        { allowBlank: false, id: 'nick', fieldLabel: 'User ID', name: 'user', emptyText: 'nickname' },
        { allowBlank: false, id: 'pass', fieldLabel: 'Password', name: 'pass', emptyText: 'password', inputType: 'password' },
        {
            xtype: 'container',
...
console.log("LawerAdminApp.view.LoginPanel.js end ....");
