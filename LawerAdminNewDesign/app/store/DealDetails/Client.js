var myDealDetailsClients = {
    "total": "26",
    "clients": [  { id: "0",  lastname: "qwertyA", firstname: "awerty", phone: "1234561", email: "awerty@gmail.com"        },
...
Ext.define('LawerAdminApp.store.DealDetails.Client', {
    extend: 'Ext.data.Store',
    requires: [
        'LawerAdminApp.model.Client',
    ],
    storeId: 'DealDetailsClient',
    ...
    data: myDealDetailsClients
});
console.log("LawerAdminApp.store.DealDetails.CLients.js ends ....");
