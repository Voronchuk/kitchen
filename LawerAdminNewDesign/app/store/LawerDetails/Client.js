Ext.require(['LawerAdminApp.store.Client']);

var myLawerDetailsClient = {
    "total": "26",
    "clients": [
...
Ext.define('LawerAdminApp.store.LawerDetails.Client', {
    extend:  'Ext.data.Store',
    requires: [
        'LawerAdminApp.model.Client',
       ],
    storeId: 'LawerDetailsClient',
