var myClientDetailsDeals = {
    ...
    "deals":[
        ...
        {"id": "4",   'description': "   Prof. Preobrazhensky Deal                           ",    "lawer_id": "4",    "client_id": "4",   "service_id": "4",  "start": new Date("03/01/2012"),    "end": new Date("03/01/2012"),  "status":"completed",   "cost":"100.00"  },
        ...
        {"id": "6",                                                                                "lawer_id": "1",    "client_id": "6",   "service_id": "6",  "start": new Date("03/01/2012"),    "end": new Date("03/01/2012"),  "status":"completed",   "cost":"0.00"  },
        {"id": "7",                                                                                "lawer_id": "1",    "client_id": "0",   "service_id": "7",  "start": new Date("03/01/2012"),    "end": new Date("03/01/2012"),  "status":"completed",   "cost":"0.00"  },
...
Ext.define('LawerAdminApp.store.ClientDetails.Deal', {
    extend: 'Ext.data.Store',
    requires: ['LawerAdminApp.model.Deal'],
    storeId: 'ClientDetailsDeal',
